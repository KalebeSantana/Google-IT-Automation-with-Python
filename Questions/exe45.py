...
house_number and street_name, and returns: "house number X on street named Y". The format of 
the input string is: numeric house number, followed by the street name which may contain numbers, 
...
def format_address(address_string):
    list_address = address_string.split()
    number = list_address[0]
    street = " ".join(list_address[1:])
